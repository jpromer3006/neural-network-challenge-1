...
def caviar_coach(taste_profile, texture_preference, budget):
    ...
    try:
        ...
        Your Imperial Highness,<br><br>

        Based on your exquisite preferences, I am honored to present our recommendation:<br><br>

        {response}<br><br>

        May this experience elevate your senses and leave an indelible mark on your palate.<br><br>

        Bon appétit, Your Highness.<br><br>  
        For more exclusive insights, visit us at: <a href="https://www.caviart.club" target="_blank">here</a>
        """
...
iface = gr.Interface(
    ...
    outputs=gr.HTML(label="Your Royal Recommendation"),
